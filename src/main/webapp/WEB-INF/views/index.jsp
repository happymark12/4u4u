...
-->
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$.ajax({
				url : '/4u4u/_4u4u/controller/ProcessSearchIndex.do', //要呼叫的網址列或檔案
				type : 'GET', //GET或POST
				dataType : 'json',
				success : function(data) {
						for(let i=0;i<data.length;i++){
							...
							apiData = `<div class="col-md-4"><article class="aa-properties-item">`;
	                        if(data[i].adImages.length==0){
	                            apiData+= `<a href="/4u4u/_4u4u/roomRentDetail?adStyle=0&adId=`+data[i].adId+`" class="aa-properties-item-img"> <img src="${pageContext.request.contextPath}/img/NoImage.png" alt="img"></a>`;
	                        }else{
