...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/wantedroom.js"></script>
<script
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul id="top-menu" class="nav navbar-nav navbar-right aa-main-nav">
						...
						<li class="dropdown "><a class="dropdown-toggle active"
							data-toggle="dropdown">發佈廣告 <span class="caret"></span></a>
				...
				<td>
					<fieldset>
						...
						性別人數: <select name="peopleNum_gender" id="peopleNum_gender"
							onchange="selectGenderToAge(this[selectedIndex].value)" required>
						...
						<br> 房間類型: <select name="severalSuites" id="severalSuites"
							required>
							<option value="">-</option>
						</select>間套房 <select name="severalRooms" id="severalRooms" required>
							<option value="">-</option>
						</select>間雅房 <br>
						<br>
						...
						<br> 租金預算: <input id="budget" name="budget" type="number"
							min="0" max="100000000" required>元/月<br>
						<br> 可入住日期: <input type="date" name="checkInDate"
							id="checkInDate"><br>
						<br> 居住時間: <select name="liveTime" id="livetime">
						...
						年齡: <span id="ageDiv"> <select name="age" id="age">
								<option value="default">-</option>
						</select>歲
						</span>
						<!-- 當性別人數為複數時,動態出現年齡範圍(ageRange) -->
						<span id="ageRange" style="display: none"> <select
							name="ageMin" id="ageMin">
								<option value="default">-</option>
						</select>歲到<select name="ageMax" id="ageMax">
								<option value="default">-</option>
						</select>歲
						</span> <br>
						<br> 職業: <select name="job" id="job">
							<option value="學生">學生</option>
							<option value="上班族">上班族</option>
							<option value="混合">混合</option>
							<option value="其他">其他</option>
						</select><br>
						<br> 是否抽菸: <select name="allowSmoke" id="allowSmoke">
							<option value="false">否</option>
							<option value="true">是</option>
						</select><br>
						<br> 是否養寵物: <select name="allowPet" id="allowPet">
							<option value="false">否</option>
							<option value="true">是</option>
						</select><br>
						<br> 性向: <select name="sexualOrientation"
			...
			<tr>
				<td>
					...
					<fieldset id="wantedRoommates">
						...
						<br> 年齡: <select name="roommatesAgeMin" id="roommatesAgeMin">
							<option value="default">-</option>
						</select>歲到 <select name="roommatesAgeMax" id="roommatesAgeMax">
							<option value="default">-</option>
						</select>歲 <br>
						<br> 職業: <select name="wantedRoommatesJob"
							id="wantedRoommatesJob">
							<option value="學生">學生</option>
							<option value="上班族">上班族</option>
							<option value="不介意">不介意</option>
						</select><br>
						<br> 是否抽菸: <select name="wantedRoommatesSmoke"
							id="wantedRoommatesSmoke">
							<option value="false">否</option>
							<option value="true">是</option>
						</select><br>
						<br> 是否養寵物: <select name="wantedRoommatesPet"
							id="wantedRoommatesPet">
							<option value="false">否</option>
							<option value="true">是</option>
						</select><br>
						<br> 性向: <select name="wantedRoommatesSex"
							id="wantedRoommatesSex">
							<option value="不介意">不介意</option>
							<option value="異性戀">異性戀</option>
							<option value="同性戀">同性戀</option>
							<option value="雙性戀">雙性戀</option>
			...
			<tr>
				<td>
					<fieldset id="adTitle">
						...
						<br> (簡短的介紹)<br>
						<br> 現況描述:
						<textarea name="adDescription" rows="10" cols="50" required></textarea>
						<br>
						<br> （描述中不允許使用聯繫方式)<br>
						<br>
