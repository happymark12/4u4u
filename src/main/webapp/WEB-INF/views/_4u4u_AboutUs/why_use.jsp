...
<body>
  ...
  <section id="aa-blog" style="clear: both">
                        ...
                        <span  style="text-align: left;width: 50%;font-family: malgun gothic">
                          ...
                          <h5>只需點擊幾下即可發布廣告或搜索廣告，網站以清楚明瞭為設計核心讓您好掌握。</h5> 
                          <h3 style="color: #59abe3">透過大家不斷發佈的廣告可以有最多的選擇</h3>
                          <h5>我們每個月有200萬訪客，裡面滿是潛在的室友等著您。更多的人意味著更多的選擇
                            ，也有更多的機會找到真正與您交心的室友。</h5>
                          <h3 style="color: #59abe3">專人維持廣告的安全真實性</h3>
                          <h5>我們擁有一支由實際人員組成的團隊，負責檢查4U4U上的每則廣告，確保您的安全是
                          我們的首要任務。</h5>
                          <h3 style="color: #59abe3">可以直接面對面地認識潛在室友</h3>
                          <h5>可以參加我們的活動，您將可以一口氣結識很多新朋友。</h5>
                          <h3 style="color: #59abe3">遇到困難，我們及時解救</h3>
                          <h5>我們樂意為您提供操作方法和建議，歡迎聯絡我們，我們會在三聲鈴響之內接聽您的電話
                            ，或者，如果您偏好使用電子郵件，我們將會在24小時內回覆您。</h5>
