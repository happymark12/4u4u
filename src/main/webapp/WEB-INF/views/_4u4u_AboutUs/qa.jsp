...
<body>
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul id="top-menu" class="nav navbar-nav navbar-right aa-main-nav">
						...
						<li class="dropdown  "><a class="dropdown-toggle active"
							data-toggle="dropdown">關於我們 <span class="caret"></span>
						</a>
							<ul class="dropdown-menu" role="menu">
								...
								<li><a class="active" href="<c:url value='/qa' />">常見問與答</a></li>
							</ul></li>
					</ul>
				</div>
			</div>
	...
	<section id="aa-blog" style="clear: both">
		...
		<div style="text-align: center; width: 100%">
			<div style="text-align: left; width: 70%; margin: 0px auto">

				<span
					style="text-align: left; width: 70%; font-family: malgun gothic">
					<h2 style="color: #59abe3">我該如何開始？</h2>
					<h3>
						您可以在沒有帳戶的情況下在4U4U上搜索和瀏覽所有廣告， 但是您需要註冊（免費）才能發佈廣告或聯繫其他用戶。<a
							href="register.html">現在免費註冊。</a>
					</h3>
					<h2 style="color: #59abe3">如何發佈廣告？</h2>
					<h3>要在4U4U上發佈廣告，請在主選單中單擊“發佈廣告”。要宣傳房間，請選擇第一個類別“出租廣告”。
						要找尋房間及室友，請選擇第二個類別“找房廣告”，並填寫詳細訊息，以使人們知道您要尋找的內容。</h3>
					<h2 style="color: #59abe3">如何修改個人資料？</h2>
					<h3>請至帳戶管理頁面，點選修改個人資料。</h3>
					<h2 style="color: #59abe3">什麼是精選廣告？</h2>
					<h3>精選廣告在搜索結果頁上以紅色突出顯示，並且位於同一年齡的免費列表上方。
						升級還包括“搶先體驗”功能，因此您可以聯繫所有其他用戶（那些廣告室或正在
						尋找房間的用戶）。升級費用為7天XXXX台幣-如果您擁有多個物業，則升級還 可以讓您通過購買額外的房源來管理多個廣告。</h3>
					<h2 style="color: #59abe3">如何將照片上傳到廣告中？</h2>
					<h3>
						所有用戶最多可以免費添加9張照片到他們的廣告中。您需要登錄到您的帳戶才能執行此操作。<br> 運作方式如下：<br>
						...
						突出顯示要添加的照片，然後單擊“打開”。這將用文本填充瀏覽按鈕旁邊的框 點擊“上傳”按鈕 上傳後，照片將在頁面下方顯示為小圖像。
						上傳完所有照片後，您可以更改它們的顯示順序或添加標題。要更改照片的順序，請單擊並按住照片並將其拖到首選位置。
					</h3>
					<h2 style="color: #59abe3">如何修改廣告？</h2>
					<h3>
						要修改廣告，請執行以下操作：<br> 1.登錄並轉到“帳戶管理”底下的“我的廣告”。<br>
						2.在“我的已發布廣告”屏幕上，您會看到一個灰色框，標題為我的提供/想要的廣告，帶有廣告的參考編號 和標題。<br>
						3.選擇“編輯”。<br> 4.下一頁是“編輯”屏幕。您將能夠更改由編輯框包圍的所有信息。完成所有更改後，滾動到頁面底部。<br>

						5.選擇“保存”。 然後，您的更改將在90分鐘內在網站上生效。
					</h3>
					<h2 style="color: #59abe3">我需要付什麼錢嗎？</h2>
					<h3>
						任何人都可以完全免費使用4U4U。<BR>

						如果您正在尋找一個房間並希望立即與所有廣告聯繫，則可以選擇升級以儘早使用鳥類。如果您選擇不升級，則仍然可以聯繫7天以上的精選廣告和廣告。7天后可以免費聯繫早鳥廣告。
						<BR> 免費廣告在列表中顯示為灰色。升級後的用戶可以立即與您聯繫-廣告發布7天后，其他所有人都可以與您聯繫。 <BR>
						如果您選擇升級，則意味著您的廣告將在列表中顯示為藍色粗體廣告，並且每個人都可以立即與您聯繫。您可以立即與任何房間內想要的廣告聯繫，因為升級也可以讓您早起購票。
					</h3>
					<h2 style="color: #59abe3">為什麼我還沒有收到回复？</h2>
					<h3>
						有些用戶檢查電子郵件和/或登錄4U4U的頻率比其他用戶少-您應該耐心等待，至少需要48小時才能回复。 <BR>
						如果用戶出於任何原因決定您不適合該房間，則他們可能會選擇不做出響應，以免感到冒犯。我們嘗試通過提供自動拒絕響應來使人們易於響應。 <BR>
						我們無法控制的其他原因可能是用戶提供了錯誤的電子郵件地址或房間被出租。我們會定期發送提醒，讓用戶很容易告訴我們何時佔用房間，但並非所有人都能及時刪除廣告。我們一直在尋找更好的方法來更早地刪除廣告，以解決此問題。
					</h3>
				</span>
			</div>
		</div>
