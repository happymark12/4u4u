...
<body class="aa-price-range">
	...
	<section id="aa-property-header" class="my-rent">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
...
-->
						...
						<div class="aa-properties-content-body" style="margin-left: 0px">
							...
							<ul class="aa-properties-nav  my-ad">
								<c:forEach var="roomRentAd" items="${roomRentAd}" varStatus="vs">

									<li class="list">

										<article class="aa-properties-item">
											<c:if test="${roomRentAd.adState == true}">
												<a class="aa-properties-item-img"
													href="<c:url value='/_4u4u/roomRentDetail?adStyle=0&adId=${roomRentAd.adId}'/>">
													<c:if test="${! empty roomRentAd.adImages}">
														<img alt="img"
															src="/disksource/roomRentAd/${roomRentAd.adImages}">
													</c:if> <c:if test="${ empty roomRentAd.adImages}">
														<img alt="img"
											...
											<c:if test="${roomRentAd.adState == false}">
											...
											<c:if test="${roomRentAd.adState == true}">
												...
												<div class="aa-properties-item-content">
													...
													<div class="aa-properties-about  text-center">
														<h3>
															<a
																href="<c:url value='/_4u4u/roomRentDetail?adStyle=0&adId=${roomRentAd.adId}'/>">${roomRentAd.adTitle}</a>
														</h3>
														<p>${roomRentAd.adAreacode}</p>
														<c:if
															test="${roomRentAd.adRentType=='獨立套房'||roomRentAd.adRentType=='分租套房'||roomRentAd.adRentType=='出租房間(有公共空間)'}">

															<span class="aa-price">租金:${roomRentAd.adDeposit}元/月</span>
														</c:if>
														<c:if test="${roomRentAd.adRentType=='整層出租'}">
															<span class="aa-price">租金:$${roomRentAd.adRentPrice}元/月</span>
														</c:if>
													</div>
													<div class="aa-properties-detial">
														<c:if test="${roomRentAd.adPhone == '早鳥'}">
														...
														<a class="aa-secondary-btn"
															href="<c:url value='/_4u4u/roomRentDetail?adStyle=0&adId=${roomRentAd.adId}'/>">了解更多</a>
													</div>
													<div class="aa-properties-detial">
														<span class="aa-price"> <a class="deleteButton"
															href="<c:url value='/_4u4u/deleteRoomRentAd?memId=${LoginOK.memId}&adStyle=${adStyle}&adId=${roomRentAd.adId}'/>"><i
																class="fa fa-trash fa-lg" style="color: red"></i>刪除</a> <a
															href="<c:url value="/_4u4u/ProcessUpdateRoomRentAd?memId=${LoginOK.memId}&adStyle=${adStyle}&adId=${roomRentAd.adId}"/>"
															class="edit"><i class="fa fa-pencil-square-o fa-lg"
																style="color: #9F68E4"></i>編輯</a>
														</span>
														<c:if test="${roomRentAd.adState == true}">
															<a class="stop stop-ad"
																href="<c:url value='/_4u4u/ChangeRoomRentAdState?memId=${LoginOK.memId}&adStyle=${adStyle}&adId=${roomRentAd.adId}'/>"
											...
											<c:if test="${roomRentAd.adState == false}">
												...
												<div class="aa-properties-item-content disable">
													...
													<div class="aa-properties-about  text-center">
														...
														<c:if test="${roomRentAd.adRentType=='整層出租'}">
															<span class="aa-price">$${roomRentAd.adRentPrice}</span>
														</c:if>
													</div>
													<div class="aa-properties-detial">
														<!-- 												拿adPhone來暫存早鳥或可直接聯繫的判斷 -->
														<c:if test="${roomRentAd.adPhone == '早鳥'}">
															<span class="aa-price demo2" data-placement="bottom"
																title="一般會員需等廣告發佈7天後才能直接聯繫,如需立即聯繫必先升級為VIP會員。"> <i
																class="fas fa-crow fa-lg" style="color: orange"></i>早鳥體驗
								...
								<ul class="pagination">
									...
									<c:forEach var="i" begin="${begin}" end="${end}">
										...
										<c:choose>
											...
											<c:otherwise>
												<li><a
													href="<c:url value='MyAdServlet?pageNo=${i}&memId=${LoginOK.memId}&adStyle=0'/>">${i}</a></li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
