...
public class GlobalService {
	...
	public static final String SYSTEM_NAME = "4u4u室友是友";
	public static final int IMAGE_FILENAME_LENGTH = 20;
	public static final String JNDI_DB_NAME = "java:comp/env/jdbc/4u4uDataMySQL";
...
//		System.out.println("SHA1:" + t1);
		...
		String result =  GlobalService.getMD5Endocing(GlobalService.encryptString("123"));
